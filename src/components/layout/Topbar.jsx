    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[var(--border)] bg-[color:var(--background)]/80 px-4 backdrop-blur-xl lg:px-6">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="focus-ring flex w-[min(50vw,420px)] items-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-left text-sm text-muted"
        >
          <Search size={17} />
          <span className="truncate">Search tools, prompts, pages…</span>
          <kbd className="ml-auto hidden rounded border border-[var(--border)] px-2 py-0.5 text-xs sm:block">
            Ctrl K
          </kbd>
        </button>
      </div>
